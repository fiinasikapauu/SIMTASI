...
router.post('/uploadproposalta', requireAuth, proposalController.uploadProposal);
router.get('/downloaduploadproposalta/:id', requireAuth, proposalController.downloadProposal);
router.get('/api/uploadproposalta', requireAuth, proposalController.getProposalData);
router.delete('/deleteuploadproposalta/:id', requireAuth, proposalController.deleteProposal);
...
router.delete('/deletelaporankemajuan/:id', requireAuth, laporanKemajuanController.deleteLaporanKemajuan);
...
router.get('/downloadrevisilaporan/:id', requireAuth, revisiLaporanController.downloadRevisi);
